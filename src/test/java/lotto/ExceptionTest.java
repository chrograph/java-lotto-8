...
class ExceptionTest {
    ...
    void checkPurchaseAmount_noneInput() {
        assertThatThrownBy(() -> Exception.checkPurchaseAmount(""))
    ...
    void checkPurchaseAmount_lessAmount() {
        assertThatThrownBy(() -> Exception.checkPurchaseAmount("900"))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    void checkBonusNumber_duplicate_with_winningNumber() {
        assertThatThrownBy(() -> Exception.checkBonusNumber("6", List.of(1, 2, 3, 4, 5, 6)))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    void checkWinningNumber_notSix() {
        assertThatThrownBy(() -> Exception.checkWinningNumber(List.of(1, 2, 3, 4, 5)))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    void checkWinningNumber_duplicate() {
        assertThatThrownBy(() -> Exception.checkWinningNumber(List.of(1, 2, 3, 4, 5, 5)))
                .isInstanceOf(IllegalArgumentException.class)
